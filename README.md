...
## Установка
Приложение совместимо с операционными системами Windows и Linux. Для загрузки требуется как минимум 500 МБ свободной памяти.

Если у вас уже установлен Python 3 и библиотека PyQt5, рекомендуем в целях экономии памяти скачать [версию без виртуальной среды](https://github.com/Mednaceex/Gost_Counter_Python).
